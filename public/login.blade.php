...
<div class="authentication-wrapper authentication-cover">
  <div class="authentication-inner row m-0">
    ...
    <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
      ...
      <a href="{{url('/asistencia/create')}}" class="app-brand-link gap-2 mb-2">

          
            
<span class="app-brand-text demo h3 mb-0 fw-bold  " >CODIGO QR</span>
        ...
        <div class="app-brand justify-content-center mb-4">
          ...
          <a href="{{url('/')}}" class="app-brand-link gap-2 mb-2">
            ...
            <span class="app-brand-text demo h3 mb-0 fw-bold">Asistencia Inteligente</span>
          </a>
        ...
        <!-- /Logo -->
        <!-- <h4 class="mb-2">Asistencia Inteligente </h4> -->
